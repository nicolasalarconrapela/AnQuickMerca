...
def run(playwright):
    ...
    page.screenshot(path="/home/jules/verification/home_es_fixed2.png", animations="disabled")

    lang_btn = page.locator("[data-testid='lang-btn']")
    if lang_btn.count() > 0:
        lang_btn.click()
        page.wait_for_timeout(2000)
        page.screenshot(path="/home/jules/verification/home_en_fixed2.png", animations="disabled")
    else:
